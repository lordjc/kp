...
print """TBL_STR=CREATE TABLE %s %s %s ROW FORMAT SERDE 'org.apache.hadoop.hive.serde2.avro.AvroSerDe' STORED AS INPUTFORMAT 'org.apache.hadoop.hive.ql.io.avro.AvroContainerInputFormat' OUTPUTFORMAT 'org.apache.hadoop.hive.ql.io.avro.AvroContainerOutputFormat' location '%s' TBLPROPERTIES (   'avro.schema.url'='%s')""" % (table_name,gen_columns(schema_obj),partitions,hdfs_data_location,hdfs_avro_schema_location);
